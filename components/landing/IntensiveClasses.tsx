  ...
  return (
    <section className="relative pt-36 pb-20 px-6 overflow-hidden bg-grid-pattern">
      <motion.div
        ...
        className="absolute top-28 right-10 md:right-24 w-28 h-28 bg-[#FBE1D3] rounded-3xl border-4 border-[#0f0e0e] brutal-shadow mix-blend-multiply flex items-center justify-center -z-10"
      >
        <Flame className="w-12 h-12 text-[#0f0e0e]" />
      </motion.div>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-3xl md:text-5xl font-display font-black uppercase tracking-tight leading-[1.05]">
            Vướng lịch? Vẫn{" "}
            <span className="text-[#BCCE75]">theo kịp 100%</span> kiến thức.
          </h2>
    ...
    <section className="py-24 px-6 bg-[#0f0e0e] text-[#f4efe6]">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-6xl font-display font-black uppercase tracking-tight mb-6">
          Học chủ động, <span className="text-[#BCCE75]">không giới hạn.</span>
        </h2>
  ...
  return (
    <section className="py-24 px-6 max-w-5xl mx-auto">
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="bg-[#DBE8FB] text-[#0f0e0e] border-4 border-[#0f0e0e] rounded-[2.5rem] brutal-shadow-lg p-8 md:p-14 relative overflow-hidden"
      >
        <div className="absolute -bottom-10 -right-10 w-52 h-52 bg-[#BCCE75] rounded-full border-4 border-[#0f0e0e] mix-blend-overlay"></div>
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 bg-[#BCCE75] text-[#0f0e0e] border-2 border-[#0f0e0e] px-3 py-1 rounded-full font-bold text-xs uppercase tracking-wider mb-6">
          ...
          <p className="mt-6 text-lg md:text-xl font-medium text-[#0f0e0e]/80 max-w-2xl">
    ...
    <section id="how" className="py-24 px-6 bg-[#0f0e0e] text-[#f4efe6]">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-6xl font-display font-black uppercase tracking-tight mb-16">
          Cách <span className="text-[#BCCE75]">đăng ký.</span>
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {steps.map((s) => (
            <div
