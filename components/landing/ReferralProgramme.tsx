...
const ReferralHero = () => {
  return (
    <section className="relative pt-36 pb-20 px-6 overflow-hidden bg-grid-pattern">
      ...
      >
        <Gift className="w-12 h-12 text-[#0f0e0e]" />
      </motion.div>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-3 font-medium text-base md:text-lg">
            <li className="flex items-center gap-3">
              <span className="w-2.5 h-2.5 rounded-full bg-[#FBDAE3] border-2 border-[#0f0e0e] shrink-0" />
              The referred student&apos;s{" "}
              <span className="font-bold">Zalo phone number</span>
            </li>
            <li className="flex items-center gap-3">
              <span className="w-2.5 h-2.5 rounded-full bg-[#DBE8FB] border-2 border-[#0f0e0e] shrink-0" />
              The referred student&apos;s{" "}
